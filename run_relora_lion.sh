...
run_name="con_lora_llama2-7b_lion_gpt4_v2_4e-5_print"
lr=4e-5
bs=30
...
# one lora llama
k=1
run_name="one_lora_llama2-7b_lion_gpt4_v2_4e-5_print"
lr=4e-5
bs=30
per_device_eval_batch_size=1
use_lora=1
...
# run_name="con_lora_phi1_5_lion_gpt4_v2_6e-5_ft_per_layer_print_detail_layer"
# lr=6e-5
# bs=15
# per_device_eval_batch_size=1
# use_lora=1
