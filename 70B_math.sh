...
# k=1
# run_name="ft_llama2-70b_adamw_GSM8K_lora_rank128_5e-5_all_layers_epoch1"
# lr=5e-5
# bs=1
# per_device_eval_batch_size=1
# use_lora=1
...
# k=1
# run_name="ft_llama2-70b_adamw_GSM8K_lora_rank128_5e-5_all_layers_epoch3"
# lr=5e-5
# bs=1
# per_device_eval_batch_size=1
# use_lora=1
...
# # run_name="ft_codellama-70B_GSM8K_lr5e-5_lisa_random4_openEmdAndHead_k45"
# # lr=5e-5
# # bs=8
# # per_device_eval_batch_size=1
# # use_lora=0
