...
#       ${lora_args} \
#       --use_ram_optimized_load False \
#       --prompt_structure "###Question: How to cook a dumpling?###Answer: 1.Boil a large pot of water. 2.Add dumplings to the pot and stir gently so they don’t stick together. 3.Bring the water back to a boil and add a cup of cold water. 4.Repeat step 3 two more times. ###Question: {input_text} ###Answer:" \
#       --max_new_tokens 400\
#       --end_string "###"
