...
random_list=(10 6 4 0 10 4 7 0 10 9 4 2 7 10 8 6 10 3 0 6 6 9 0 6 8 6 0 9 2 9)
# 打印生成的随机列表
echo "Generated list: ${random_list[*]}"


run_name="ft_gpt2_adamw_C4_6e-3_continue_freeze_experiment_activate1-11_total_30_freeze_wte"
lr=6e-3
bs=200
