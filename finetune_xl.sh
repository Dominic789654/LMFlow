# bash run_relora.sh > log/con_lora_llama2-7b_lionlamb_gpt4_v2_4e-3_ft_per_weight_norm_gradient_norm_update_norm_freeze_head_embed.log 2>&1
# bash run_relora_lion.sh > log/con_lora_llama2-7b_lion_gpt4_v2_4e-5_ft_per_layer_print_detail_layer.log 2>&1
# bash run_relora_adamw.sh > log/con_lora_llama2-7b_adamw_gpt4_v2_4e-4_ft_per_weight_norm_gradient_norm_update_norm.log 2>&1
...
# bash run_relora_full_lion.sh > log_new/gpt2_lion_gpt4_v2_1e-5_ft_print_detail_layer.log 2>&1
# bash run_relora_full_adamw.sh > log_new/gpt2_adamw_gpt4_v2_1e-4_print_detail_layer.log 2>&1
