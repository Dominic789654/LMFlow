...
# run_name="con_lora_llama2-7b_adamw_gpt4_v2_4e-4_ft_print"
# lr=4e-4
# bs=30
...
# # one lora 
# k=1
# run_name="one_lora_llama2-7b_adamw_gpt4_v2_4e-4_ft_print"
# lr=4e-4
# bs=30
# per_device_eval_batch_size=1
# use_lora=1
...
# gpt2 
# k=3
# run_name="con_lora_gpt2_adamw_gpt4_v2_1e-3_ft_print"
# lr=1e-3
# bs=30
# per_device_eval_batch_size=1
# use_lora=1
...
# k=1
# run_name="one_lora_gpt2_adamw_gpt4_v2_3e-3_ft_print"
# lr=3e-3
# bs=30
# per_device_eval_batch_size=1
# use_lora=1
...
k=1
run_name="one_lora_gpt2_adamw_c4_1e-3_ft_print"
lr=1e-3
bs=200
per_device_eval_batch_size=1
use_lora=1
