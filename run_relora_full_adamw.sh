...
run_name="ft_gpt2_adamw_gpt4_v2_8e-4_print_freeze_all"
lr=8e-4
bs=30
...
bash ./scripts/run_finetune_relora_freeze.sh ${exp_name} ${data_path} ${lr} ${bs} ${model_name_or_path} ${use_lora} ${ds_config} ${epochs} ${gradient_checkpointing} ${gradient_accumulation_steps} ${lora_r} ${eval_dataset_path} ${block_size} ${per_device_eval_batch_size} ${warmup_ratio} ${num_portions} ${selected_portion} ${optimizer_name} "${freeze_layers}" "--master_port=10002 --include localhost:4,5,6,7"  

run_name="ft_gpt2_adamw_gpt4_v2_8e-4_print_freeze_frist4"
exp_name="${run_name}_0";
freeze_layers="--freeze_layers 0 1 2 3"
bash ./scripts/run_finetune_relora_freeze.sh ${exp_name} ${data_path} ${lr} ${bs} ${model_name_or_path} ${use_lora} ${ds_config} ${epochs} ${gradient_checkpointing} ${gradient_accumulation_steps} ${lora_r} ${eval_dataset_path} ${block_size} ${per_device_eval_batch_size} ${warmup_ratio} ${num_portions} ${selected_portion} ${optimizer_name} "${freeze_layers}" "--master_port=10002 --include localhost:4,5,6,7"  

run_name="ft_gpt2_adamw_gpt4_v2_8e-4_print_freeze_odd"
exp_name="${run_name}_0";
freeze_layers="--freeze_layers 1 3 5 7 9 11"
bash ./scripts/run_finetune_relora_freeze.sh ${exp_name} ${data_path} ${lr} ${bs} ${model_name_or_path} ${use_lora} ${ds_config} ${epochs} ${gradient_checkpointing} ${gradient_accumulation_steps} ${lora_r} ${eval_dataset_path} ${block_size} ${per_device_eval_batch_size} ${warmup_ratio} ${num_portions} ${selected_portion} ${optimizer_name} "${freeze_layers}" "--master_port=10002 --include localhost:4,5,6,7"  

run_name="ft_gpt2_adamw_gpt4_v2_8e-4_print_freeze_even"
exp_name="${run_name}_0";
freeze_layers="--freeze_layers 0 2 4 6 8 10"
bash ./scripts/run_finetune_relora_freeze.sh ${exp_name} ${data_path} ${lr} ${bs} ${model_name_or_path} ${use_lora} ${ds_config} ${epochs} ${gradient_checkpointing} ${gradient_accumulation_steps} ${lora_r} ${eval_dataset_path} ${block_size} ${per_device_eval_batch_size} ${warmup_ratio} ${num_portions} ${selected_portion} ${optimizer_name} "${freeze_layers}" "--master_port=10002 --include localhost:4,5,6,7"  

run_name="ft_gpt2_adamw_gpt4_v2_8e-4_print_freeze_last4"
exp_name="${run_name}_0";
freeze_layers="--freeze_layers 8 9 10 11"
bash ./scripts/run_finetune_relora_freeze.sh ${exp_name} ${data_path} ${lr} ${bs} ${model_name_or_path} ${use_lora} ${ds_config} ${epochs} ${gradient_checkpointing} ${gradient_accumulation_steps} ${lora_r} ${eval_dataset_path} ${block_size} ${per_device_eval_batch_size} ${warmup_ratio} ${num_portions} ${selected_portion} ${optimizer_name} "${freeze_layers}" "--master_port=10002 --include localhost:4,5,6,7"  

run_name="ft_gpt2_adamw_gpt4_v2_8e-4_print_freeze_middle4"
exp_name="${run_name}_0";
freeze_layers="--freeze_layers 4 5 6 7"
bash ./scripts/run_finetune_relora_freeze.sh ${exp_name} ${data_path} ${lr} ${bs} ${model_name_or_path} ${use_lora} ${ds_config} ${epochs} ${gradient_checkpointing} ${gradient_accumulation_steps} ${lora_r} ${eval_dataset_path} ${block_size} ${per_device_eval_batch_size} ${warmup_ratio} ${num_portions} ${selected_portion} ${optimizer_name} "${freeze_layers}" "--master_port=10002 --include localhost:4,5,6,7"  

run_name="ft_gpt2_adamw_gpt4_v2_8e-4_print_freeze_random4"
exp_name="${run_name}_0";
