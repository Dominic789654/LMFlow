...
k=1
run_name="A100-40*8_gpt2_lionlamb_ft_gpt4_v2_1e-3"
lr=9e-4
bs=100
...
# k=1
# run_name="A100-40*8_gpt2_lion_ft_gpt4_v2_1e-5"
# lr=1e-5
# bs=100
# per_device_eval_batch_size=1
# use_lora=0
...
k=1
run_name="A100-40*8_gpt_adamw_ft_gpt4_v2_1e-4"
lr=1e-4
bs=100
per_device_eval_batch_size=1
use_lora=0
...
# k=1
# run_name="A100-40*8_gpt2_adamw_ft_gpt4_5w_1e-4"
# lr=1e-4
# bs=15
# per_device_eval_batch_size=1
# use_lora=0
...
# k=1
# run_name="A100-40*8_llama7b_lion_ft_gpt4_5w_1e-5"
# lr=1e-5
# bs=15
# per_device_eval_batch_size=1
# use_lora=0
...
# k=1
# run_name="A100-40*8_gpt2_lionlamb_ft_gpt4_5w_1e-3"
# lr=1e-3
# bs=100
# per_device_eval_batch_size=1
# use_lora=0
...
# k=1
# run_name="A100-40*8_gpt2_lion_ft_gpt4_5w_1e-5"
# lr=1e-5
# bs=100
# per_device_eval_batch_size=1
# use_lora=0
