...
# run_name="con_lora_llama2-7b_lionlamb_gpt4_v2_4e-3_print"
# lr=4e-3
# bs=1
# per_device_eval_batch_size=1
# use_lora=1
...
# selected_portion=1
# optimizer_name=LionLamb
# bash ./scripts/run_finetune_relora.sh ${exp_name} ${data_path} ${lr} ${bs} ${model_name_or_path} ${use_lora} ${ds_config} ${epochs} ${gradient_checkpointing} ${gradient_accumulation_steps} ${lora_r} ${eval_dataset_path} ${block_size} ${per_device_eval_batch_size} ${warmup_ratio} ${num_portions} ${selected_portion} ${optimizer_name} "--master_port=10002 --include localhost:0"  
...
# one lora llama 
# k=1
# run_name="one_lora_llama2-7b_lionlamb_gpt4_v2_4e-3_print"
# lr=4e-3
# bs=15
# per_device_eval_batch_size=1
# use_lora=1
