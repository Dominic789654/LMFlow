...
def main():
    ...
    example_input = [
        '月球空心说是一个认为月球是中空的理论，而由于天然形成的星体在天文学上必然不可能空心，',
        '马丁·舒尔茨（；）德国政治人物，曾任欧洲议会议长。\n\n舒尔茨是德国社会民主党的成员。',
        '源深路，是上海市浦东新区南北向主干道路，',
        '番禺职业技术学校，又名番禺农校、；位于中国广州市番禺区市桥镇，',
        '艾希莉‧维多利亚‧班森（，） 为美国女演员及模特儿，',
    ]
    example_idx = 0
    while True:
        ...
        context = prompt_structure.format(input_text=input_text) # every time we input a new sentence, we need to reset the context
